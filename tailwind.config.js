  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 20px 40px 0 rgba(0, 0, 0, 0.12)',
        'card-lifted': '0 25px 50px -12px rgba(0, 0, 0, 0.15)',
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 25%, #fff7ed 50%, #ffedd5 75%, #fafafa 100%)',
      },
    },
  },
  plugins: [],
